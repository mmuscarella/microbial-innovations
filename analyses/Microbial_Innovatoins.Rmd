...
## Isolate Cyanobacteria: Fine Scale
```{r, results = "hide"}
...
## Phylogenetic Topological Features
```{r}
if (run.all == TRUE){
...
if (run.all == TRUE){
  ...
  system("convert -loop 10 -delay 100 
         '../figures/movie/T*.png' '../figures/movie/LTP.gif'")
  system("rm ../figures/movie/*.png")
}
```
